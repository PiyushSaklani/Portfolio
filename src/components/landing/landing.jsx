    ...
    >
      <div className="landing-text">
        ...
        <div className="landing-intro">
          Motivated individual with a strong interest in web and app development. Eager to learn and grow in the field while contributing to a team's success.
        </div>
      </div>
      ...
      {window.innerWidth >= 770 ? (
        <>
          <div
            className="landing-element-2"
            id="element"
            style={{ left: `${location.el2.l}%`, top: `${location.el2.t}%` }}
          ></div>
          <div
            className="landing-element-3"
            id="element"
            style={{ left: `${location.el3.l}%`, top: `${location.el3.t}%` }}
          ></div>
          <div
            className="landing-element-1"
            id="element"
            style={{ left: `${location.el1.l}%`, top: `${location.el1.t}%` }}
          ></div>
          <div
            className="landing-element-4"
            id="element"
            style={{ left: `${location.el4.l}%`, top: `${location.el4.t}%` }}
          ></div>
          <div
            className="landing-element-5"
            id="element"
            style={{ left: `${location.el5.l}%`, top: `${location.el5.t}%` }}
          ></div>
        </>
      ) : (
        <>
